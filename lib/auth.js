  ...
  providers: [
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        // --- START: Hardcoded Vendor Checks using Constants ---
        if (
          ...
          if (userId === "network.vendor") {
            role = USER_ROLES.NETWORK_VENDOR; // CHANGED
            name = "Network Vendor";
          } else if (userId === "telecom") {
            role = USER_ROLES.TELECOM_USER; // CHANGED
            name = "Telecom User";
          } else {
            // This block is for the 'etl' user
            role = USER_ROLES.ETL; // CHANGED to be consistent
            name = "Hardware/ETL Vendor";
          }
        ...
        if (
          ...
          return {
            ...
            role: USER_ROLES.BIOMETRIC_VENDOR, // CHANGED
            department: "Vendor",
          };
        }
        // --- END: Hardcoded Vendor Checks ---
