/*
  ...
  - You are about to drop the `TeamAvailability` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `User` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "public"."AuditTrail" DROP CONSTRAINT "AuditTrail_authorId_fkey";

-- DropForeignKey
ALTER TABLE "public"."AuditTrail" DROP CONSTRAINT "AuditTrail_incidentId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Incident" DROP CONSTRAINT "Incident_affectedUserId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Incident" DROP CONSTRAINT "Incident_assignedToId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Incident" DROP CONSTRAINT "Incident_incidentTypeId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Incident" DROP CONSTRAINT "Incident_requestorId_fkey";

-- DropForeignKey
ALTER TABLE "public"."TeamAvailability" DROP CONSTRAINT "TeamAvailability_memberId_fkey";
...
-- DropTable
DROP TABLE "public"."IncidentType";

-- DropTable
DROP TABLE "public"."TeamAvailability";
...
CREATE TABLE "public"."departments" (
    ...
    "name" TEXT NOT NULL,
    "section" TEXT NOT NULL DEFAULT 'N/A',
...
-- AddForeignKey
ALTER TABLE "public"."incidents" ADD CONSTRAINT "incidents_affectedUserId_fkey" FOREIGN KEY ("affectedUserId") REFERENCES "public"."users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
