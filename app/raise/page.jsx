      ...
      <Paper elevation={2} sx={{ p: 4 }}>
        ...
        {submissionStatus === 'success' && (
          <Alert severity="success" variant="filled">
            ...
            Your incident has been submitted successfully. A member of the C&IT team will review it shortly.
          </Alert>
        )}
        ...
        {submissionStatus === 'error' && (
           <Alert severity="error" variant="filled">
            ...
            There was a problem submitting your incident. Please try again in a few moments.
          </Alert>
        )}
      </Paper>
    </Stack>
